...
that you've already successfully installed the package.
...
All raw data should first be run through LTM_data_Summary(). This function 
...
other functions are designed to run off the output of the LTM_data_Summary().
...
LTM_data_Summary returns a list() object, containing the raw data, along with a 
...
The syntax for specifiying sizeclasses is complex, so be careful with commas and parentheses. 
